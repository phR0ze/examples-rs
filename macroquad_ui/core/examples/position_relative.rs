...
async fn main() {
    ...
    loop {
        ...
        let pos1 = Align::CenterTop(rect(0., 0., 10., 0.)).relative(size1, screen(), None);
        ...
        let pos2 = Align::Center(None).relative(size2, size1, Some(pos1));
        ...
        let pos3 = Align::Center(None).relative(size3, size2, Some(pos2));
        ...
        let pos4 = Align::Center(None).relative(size4, size3, Some(pos3));
        ...
        let pos5 = Align::CenterBottom(rect(0., 0., 0., 10.)).relative(size5, screen(), None);
        widgets::Group::new(hash!(), size5).position(pos5).ui(&mut *root_ui(), |ui| {
            ...
            let pos6 = Align::Center(None).relative(size6, size5, None);
            ...
            let pos7 = Align::Center(None).relative(size7, size5, None);
            ...
            let pos8 = Align::Center(None).relative(size8, size7, Some(pos7));
            ...
            let pos9 = Align::Center(None).relative(size9, size8, Some(pos8));
