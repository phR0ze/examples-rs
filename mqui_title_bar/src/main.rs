...
impl Resources {
    pub fn load() -> Self {
        ...
        let settings_btn_clk_bg = Image::from_file_with_format(include_bytes!("../assets/settings_clk.png"), None);
...
async fn main() {
    ...
    let titlebar = TitleBar::new(hash!("titlebar"), "Title Bar", resources.style);
