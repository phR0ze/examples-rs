...
impl Configuration {
    ...
    pub fn mutate(&mut self, action: ConfigAction) {
        ...
        match action {
            ...
            ConfigAction::SetInterfaceSoundsEnabled(flag) => self.audiovideo.interface_sounds = flag,
            ...
            ConfigAction::SetFriendsNotificationsEnabled(flag) => self.notifications.friends_notifications = flag,
