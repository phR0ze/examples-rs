...
use crate::components::{
    ...
    settings::{
        ...
        sub_pages::{
            ...
            developer::DeveloperSettings, files::FilesSettings, general::GeneralSettings,
            notifications::NotificationSettings, privacy::PrivacySettings, profile::ProfileSettings,
        },
    },
};
